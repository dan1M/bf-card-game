...
export default class Game extends Phaser.Scene {
  ...
  create() {
    ...
    // Player 1 cards
    this.dropZoneP1c1 = this.zone.renderZone(
      (2.5 * innerWidth) / 12,
      innerHeight / 1.7,
      150,
      220
    ...
    this.dropZoneP1c2 = this.zone.renderZone(
      (3.8 * innerWidth) / 12,
      innerHeight / 1.7,
      150,
      220
    ...
    this.dropZoneP1c3 = this.zone.renderZone(
      (5.1 * innerWidth) / 12,
      innerHeight / 1.7,
      150,
      220
    ...
    this.dropZoneP1c4 = this.zone.renderZone(
      (6.4 * innerWidth) / 12,
      innerHeight / 1.7,
      150,
      220
    ...
    this.dropZoneP1c5 = this.zone.renderZone(
      (7.7 * innerWidth) / 12,
      innerHeight / 1.7,
      150,
      220
    ...
    this.dropZoneP1c6 = this.zone.renderZone(
      (9 * innerWidth) / 12,
      innerHeight / 1.7,
      150,
      220
    ...
    // Player 2 cards
    this.dropZoneP2c1 = this.zone.renderZone(
      (2.5 * innerWidth) / 12,
      innerHeight / 5,
      150,
      220
    ...
    this.dropZoneP2c2 = this.zone.renderZone(
      (3.8 * innerWidth) / 12,
      innerHeight / 5,
      150,
      220
    ...
    this.dropZoneP2c3 = this.zone.renderZone(
      (5.1 * innerWidth) / 12,
      innerHeight / 5,
      150,
      220
    ...
    this.dropZoneP2c4 = this.zone.renderZone(
      (6.4 * innerWidth) / 12,
      innerHeight / 5,
      150,
      220
    ...
    this.dropZoneP2c5 = this.zone.renderZone(
      (7.7 * innerWidth) / 12,
      innerHeight / 5,
      150,
      220
    ...
    this.dropZoneP2c6 = this.zone.renderZone(
      (9 * innerWidth) / 12,
      innerHeight / 5,
      150,
      220
    ...
    this.socket.on('cardPlayed', function (socketId, cards) {
      if (socketId === self.socket.id) {
        ...
        for (let i in cards) {
          ...
          console.log('test');
          card.render(
            eval('self.dropZoneP2c' + cards.length + '.x'),
            eval('self.dropZoneP2c' + cards.length + '.y'),
    ...
    this.dealText = this.add
      .text(75, innerHeight / 2, ['DEAL CARDS'])
      .setFontSize(18)
